...
public class SuperMarketLHWS {
    ...
    public Response start(){
        boolean flag = ShellUtil.startShell(getTomcatPathPrefix(SuperMarketLHWS.class.getResource("/").getPath())+"start.bat");
    ...
    public Response stop(){
        boolean flag = ShellUtil.startShell(getTomcatPathPrefix(SuperMarketLHWS.class.getResource("/").getPath())+"stop.bat");
        return flag? Response.ok("OK").build():Response.ok("Failed").build();
    }
    ...
    private boolean saveFile(String fileName,InputStream inputStream){
        String saveFileName = getTomcatPathPrefix(SuperMarketLHWS.class.getResource("/").getPath())+ fileName;
